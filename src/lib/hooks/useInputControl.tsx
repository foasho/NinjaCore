...
export const useInputControl = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (deviceType === 'mobile' || (deviceType === 'tablet' && joystickOuter.current)) {
...
const InputControlContext = createContext<InputControlProps>({} as InputControlProps)

export const InputControlProvider = ({ children }: { children: React.ReactNode }) => {
