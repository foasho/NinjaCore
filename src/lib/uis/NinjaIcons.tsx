...
import { BsHandbagFill, BsFillBookmarkStarFill } from "react-icons/bs";
import { GiSpinningSword, GiBroadsword, GiJumpAcross } from "react-icons/gi";
  ...
  return (
    <>
      {props.icons.map((prop, index) => {
        return <CreateIcon {...prop} key={index} />;
      })}
    </>
  );
};
